                    ...
                    <div class="row">
                        <?php
                            include 'connection/connection.php';
                                ...
                                $total_pages_sql = "SELECT COUNT(*) FROM buildings where type='$type' and expiredate>= now() ";
                            ...
                            $sql ="SELECT * FROM buildings where type='$type' and expiredate>= now() ORDER BY id DESC LIMIT $offset, $no_of_records_per_page";
                ...
                ?>
                    <ul class="pagination pagination-sm pull-right push-down-20">
                        <?php if($page <= 1){ 
                                ...
                                echo '<li class=""><a href="index.php?page=views/homes/_filter_index&get_id='.$type.'&pages=1">First</a></li>';
                            }
                        ?>
                        <li class="<?php if($page <= 1){ echo 'disabled'; } ?>">
                            <a href="<?php if($page <= 1){ echo '#'; } else { echo "index.php?page=views/homes/_filter_index&get_id=".($type)."&pages=".($page - 1); } ?>">Prev</a>
                        </li>
                        <li class="<?php if($page >= $total_pages){ echo 'disabled'; } ?>">
                            <a href="<?php if($page >= $total_pages){ echo '#'; } else { echo "index.php?page=views/homes/_filter_index&get_id=".($type)."&pages=".($page + 1); } ?>">Next</a>
                        </li>
                        <li><a href="index.php?page=views/homes/index&get_id=<?php echo $type; ?>&pages=<?php echo $total_pages; ?>">Last</a></li>
                    </ul>
            <?php } ?>
