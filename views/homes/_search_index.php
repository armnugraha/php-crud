                    ...
                    <div class="row">
                        <?php
                            include 'connection/connection.php';
                                ...
                                $total_pages_sql = "SELECT COUNT(*) FROM buildings where title LIKE '%$title%' and expiredate>= now() ";
                                $result = mysql_query($total_pages_sql);
                                $total_rows = mysql_fetch_array($result)[0];
                                $total_pages = ceil($total_rows / $no_of_records_per_page);

                                $sql ="SELECT * FROM buildings where title LIKE '%$title%' and expiredate>= now() ORDER BY id DESC LIMIT $offset, $no_of_records_per_page";
                            ...
                            if ($cek == null) {
                                echo "Data Tidak ditemukan untuk pencarian ".$title;
                            }else{
                ...
                ?>
                    <ul class="pagination pagination-sm pull-right push-down-20">
                        <?php if($page <= 1){ 
                                ...
                                echo '<li class=""><a href="index.php?page=views/homes/_search_index&get_id='.$city.'&pages=1">First</a></li>';
                            }
                        ?>
                        <li class="<?php if($page <= 1){ echo 'disabled'; } ?>">
                            <a href="<?php if($page <= 1){ echo '#'; } else { echo "index.php?page=views/homes/_search_index&get_id=".($city)."&pages=".($page - 1); } ?>">Prev</a>
                        </li>
                        <li class="<?php if($page >= $total_pages){ echo 'disabled'; } ?>">
                            <a href="<?php if($page >= $total_pages){ echo '#'; } else { echo "index.php?page=views/homes/_search_index&get_id=".($city)."&pages=".($page + 1); } ?>">Next</a>
                        </li>
                        <li><a href="index.php?page=views/homes/_search_index&get_id=<?php echo $city; ?>&pages=<?php echo $total_pages; ?>">Last</a></li>
                    </ul>
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <ul class="list-tags push-up-10">
                        <li><a href="index.php?page=views/homes/_search_index&get_id=Bandung"><span class="fa fa-map-marker"></span> Bandung</a></li>
                        <li><a href="index.php?page=views/homes/_search_index&get_id=Jakarta"><span class="fa fa-map-marker"></span> Jakarta</a></li>
                        <li><a href="index.php?page=views/homes/_search_index&get_id=Garut"><span class="fa fa-map-marker"></span> Garut</a></li>
                        <li><a href="index.php?page=views/homes/_search_index&get_id=Yogyakarta"><span class="fa fa-map-marker"></span> Yogyakarta</a></li>
                    </ul>
                </div>
            </div>
