                    ...
                    <div class="row">
                        <?php
                            include 'connection/connection.php';
                                ...
                                $total_pages_sql = "SELECT COUNT(*) FROM buildings where expiredate>= now()";
                            ...
                            $sql ="SELECT * FROM buildings where expiredate>= now() ORDER BY id DESC LIMIT $offset, $no_of_records_per_page";
