                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $sql ="SELECT * FROM users ORDER BY id DESC LIMIT $offset, $no_of_records_per_page";
                                    ...
                                    <tr>
                                        ...
                                        <td style="background-color: #FFF !important; border-bottom: 2px solid #F5f5f5;"><?php echo htmlspecialchars($record['email']);?></td>
                                        <td style="background-color: #FFF !important; border-bottom: 2px solid #F5f5f5;"><?php echo $record['contact'];?></td>
                                        <td style="background-color: #FFF !important; border-bottom: 2px solid #F5f5f5;">
                                            <a href="index.php?page=views/users/edit&get_id=<?php echo $record['id']; ?>"><button class="btn btn-default btn-rounded btn-condensed btn-sm" data-toggle="tooltip" data-placement="right" title="" data-original-title="Edit User"><span class="fa fa-pencil"></span></button></a>
                                            <a href="controller/edit_user.php?get_id=<?php echo $record['id']; ?>"><button class="btn btn-danger btn-rounded btn-condensed btn-sm" data-toggle="tooltip" data-placement="right" title="" data-original-title="Delete User" onClick="delete_row('trow_1');"><span class="fa fa-times"></span></button></a>
                                        </td>
                                    </tr>
                                    <?php } } ?>
                                </tbody>
                            ...
                            ?>
                                <ul class="pagination pagination-sm pull-right push-down-20">
                                    <?php if($page <= 1){ 
                                            ...
                                            echo '<li class=""><a href="index.php?page=views/admin/_index_user&pages=1">First</a></li>';
                                        }
                                    ?>
                                    <li class="<?php if($page <= 1){ echo 'disabled'; } ?>">
                                        <a href="<?php if($page <= 1){ echo '#'; } else { echo "index.php?page=views/admin/_index_user&pages=".($page - 1); } ?>">Prev</a>
                                    </li>
                                    <li class="<?php if($page >= $total_pages){ echo 'disabled'; } ?>">
                                        <a href="<?php if($page >= $total_pages){ echo '#'; } else { echo "index.php?page=views/admin/_index_user&pages=".($page + 1); } ?>">Next</a>
                                    </li>
                                    <li><a href="index.php?page=views/admin/_index_user&pages=<?php echo $total_pages; ?>">Last</a></li>
                                </ul>
                        <?php } ?>
                    </div>
                </div>
